...
import { faqCategories } from './FAQsData.js'; // Import from your existing data file
import './FAQsPage.css'; // Ensure FAQsPage.css is in the same directory
...
const categoryIcons = {
  ...
  // Default icon if category not found or for generic display
  'default': HelpCircle
};
